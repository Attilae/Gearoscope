...
class PhoneregistrationController extends Zend_Controller_Action {

    public function init() {
        parent::init();
        $layout = Zend_Layout::getMvcInstance();
        $layout->setLayoutPath(APPLICATION_PATH . '/layouts/scripts');
        $layout->setLayout('phoneregistration');
    ...
    public function indexAction() {
        ...
        $form->setDecorators(array(array('ViewScript', array('viewScript' => 'phoneregistration/form.phtml'))));
        ...
        if ($this->getRequest()->isPost()) {
            if ($form->isValid($_POST) && $form->getValue("terms")) {
                ...
                $this->_redirect('/phoneregistration/successfull');
            } else {
